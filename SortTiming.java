...
/**
 * SortTiming A class which manages various sorting algorithms and reports the
 * timing of them. This main class contains some basic code to get started.
 * 
 * @author dgbrizan
 *
 */
public class SortTiming {
	...
	protected SortingFactory factory; // This creates different sorting
										// algorithms.
	protected String[] algorithms = { "quicksort", "mergesort",
			"insertionsort", "bubblesort", "selectionsort" }; // Algos to use.
	...
	public SortTiming(int arraySize) {
		...
		factory = new SortingFactory(false); // Do not use a default value for
												// the algorithm name.
	}
	...
	public void printSortingTiming() {
		// Objective:
		// 1) Feed "algorithms" variable to the factory in order to get a
		// sorting algorithm:
		for (String algo : algorithms) {
			try {
				...
				System.out.println("Unable to instantiate sorting algorithm "
						+ algo);
			}
		}
	}
	...
	public static void main(String[] args) {
		...
		int[] sizes = { 50000, 100000, 150000, 200000, 250000, 300000, 350000,
